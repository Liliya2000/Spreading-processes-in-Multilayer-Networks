...
namespace Network
{
    ...
    public partial class Form1 : Form
    {
        ...
        //public class Sost
        //{
        //    public bool S = true, I, R;
        //    int iter;
        //    public Sost(bool S, bool I, bool R, int iter)
        //    {
        //        this.S = S;
        //        this.I = I;
        //        this.R = R;
      ...
      public  class Node
        {
            ...
            //public List<Sost> Sost = new List<Sost>();
            public Node(List<Node> Node)
            {
                this.Near = Node;
            }
            //public Node(List<Sost> Sost)
            //{
            //    this.Sost = Sost;
            //}
       ...
       public static  List<Node> Nodes = new List<Node>();
        //public static List<Sost> Nodes_sost = new List<Sost>();
        ...
        private void Draw1_Click(object sender, EventArgs e)
        {
            ...
            for (var i = 0; i < n; i++)
                for (var j = 0; j < m; j++)
                {
                    //Nodes_sost.Add(new Sost(true, false, false, 0));
        ...
        //private void infection4_Click(object sender, EventArgs e)
        //{
        ...
        //    //int RecoveryTime = Convert.ToInt32(textBox4.Text);
        //    //int b = Substring(0, maskedTextBox1.Text.Length - 1);
